...
## Problems of a broken workflow {.build}
...
- Download http://bit.ly/DEAD_datasets

- With dataset trees.txt, analyse relationship between DBH and height.



## Steps

- Create Rstudio project (in Dropbox folder)

- Create folder structure

- Save original data in data-raw folder.

- Set up OSF

- Data quality control in R
